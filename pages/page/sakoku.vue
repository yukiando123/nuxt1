...
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div class="mb-10 md:mb-16">
            <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-6">SAKOKU NFTマーケットプレイス</h2>
...
<div class="max-w-screen-lg px-4 md:px-8 mx-auto">
    ...
    <thead>
        <tr>
            ...
            <td class="border px-4 py-2">SAKOKU NFTマーケットプレイス</td>
        </tr>
    </thead>
    <tbody>
        <tr>
        ...
        <tr>
            ...
            <td class="border px-4 py-2">https://sakoku.world/</td>
        </tr>
        <tr>
            <th class="border px-4 py-2">Scale</th>
            <td class="border px-4 py-2">社内メンバー2名</td>
        </tr>
        <tr>

...
<div class="max-w-screen-lg px-4 md:px-8 mx-auto">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="border px-4 py-2">30,000,000~</td>
        </tr>
        <tr>
            <th class="border px-4 py-2">Active user</th>
            <td class="border px-4 py-2">80,000~</td>
        </tr>
        <tr>
            <th class="border px-4 py-2">in charge of</th>
            <td class="border px-4 py-2">
            Project management(Front end), Site design, Site cording
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="border px-4 py-2">Laravel, HTML, CSS</td>
        </tr>
        </tbody>
    </table>
    </div>

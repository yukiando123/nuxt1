...
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div class="mb-10 md:mb-16">
            <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-6">CAT_BO</h2>
...
<div class="max-w-screen-lg px-4 md:px-8 mx-auto">
    ...
    <tbody>
        <tr>
            ...
            <td class="border px-4 py-2">アトランティックデザイン株式会社</td>
        </tr>
        <tr>
            <th class="border px-4 py-2">リンク</th>
            <td class="border px-4 py-2">https://cat-bo.com</td>
        </tr>
        <tr>
            <th class="border px-4 py-2">Scale</th>
            <td class="border px-4 py-2">2,000,000~, 社内メンバー1名</td>
        </tr>
        <tr>
            <th class="border px-4 py-2">担当</th>
            <td class="border px-4 py-2">
            プロジェクトリーダー、要件定義、サイトデザイン、サイトコーディング、機能開発(WordPress：スタッフ管理、シフト管理等)、グラフィックデザイン（ポストカード、名刺、パンフレット、看板）
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="border px-4 py-2">PHP, HTML, CSS, JavaScript, WordPress</td>
        </tr>
        </tbody>
    </table>
    </div>
